(function() {
    ...
    // Click on convoy row — handled by inline expand/collapse (see below)
    // openConvoyDetail is only called from linkify onclick handlers
    ...
    // ============================================
    // Convoy expand/collapse: detail rows are server-rendered, just toggle visibility
    document.addEventListener('click', function(e) {
        ...
        // Find the server-rendered detail row (next sibling with matching data-convoy-id)
        var detailRow = row.nextElementSibling;
        if (!detailRow || !detailRow.classList.contains('convoy-detail-row')) return;
